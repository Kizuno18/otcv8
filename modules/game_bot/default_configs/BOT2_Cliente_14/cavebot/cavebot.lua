...
cavebotMacro = macro(20, function()
  ...
  if storage.caveBot.forceHPandMPRefill.enabled and 
    (hppercent() < storage.caveBot.forceHPandMPRefill.hp or manapercent() < storage.caveBot.forceHPandMPRefill.mp) then
    return
  end
